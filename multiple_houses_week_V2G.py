...
axs[0].plot(pv_profile_15min*pv_sol, label='PV')
axs[0].plot(wind_profile_15min*wind_sol, label='Wind', linestyle='--')
axs[0].set_xlabel('Interval (15 min)')
axs[0].set_ylabel('Power (kW)')
axs[0].legend()
axs[1].plot(grid_energy_values, label='Grid', linestyle='--', color='green')
axs[1].set_xlabel('Interval (15 min)')
